...
public class CubicSpline{
    	...
    	public void orderPoints(){
    	    ...
    	    MathFns.selectionSort(this.x, dummy, this.newAndOldIndices);
    	    // Sort x into ascending order and make y match the new order storing both new x and new y
    	    MathFns.selectionSort(this.x, this.y, this.x, this.y);

    	    // Minimum and maximum values and range
    	    this.xMin = MathFns.minimum(this.x);
    	    this.xMax = MathFns.maximum(this.x);
    	    range = xMax - xMin;
    	}
