...
/*********************************************************/
        ...
        public static Complex truncate(Complex x, int prec){
                ...
                xR = MathFns.truncate(xR, prec);
                xI = MathFns.truncate(xI, prec);
        ...
        public static Complex times(Complex a, double b){
                ...
                if(Complex.infOption){
                    ...
                    if(MathFns.isInfinity(b) && !a.isZero()){
                        c.reset(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
                        return c;
                    }
                }
        ...
        public static Complex times(double a, Complex b){
                ...
                if(Complex.infOption){
                    ...
                    if(MathFns.isInfinity(a) && !b.isZero()){
                        c.reset(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
                        return c;
                    }
                }
        ...
        public Complex times(double a){
                ...
                if(Complex.infOption){
                    ...
                    if(MathFns.isInfinity(a) && !this.isZero()){
                        b.reset(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
                        return b;
                    }
                }
        ...
        public void timesEquals(double a){
                boolean test = true;
                if(Complex.infOption){
                    if((this.isInfinite() && a!=0.0D) || (MathFns.isInfinity(a) && !this.isZero())){
                        this.real = Double.POSITIVE_INFINITY;
                        this.imag = Double.POSITIVE_INFINITY;
                        test = false;
                    }
        ...
        public static Complex over(Complex a, double b){
                Complex c = new Complex(0.0D, 0.0D);
                if(Complex.infOption && MathFns.isInfinity(b))return c;
        ...
        public static Complex over(double a, Complex b){
                Complex c = new Complex();
                if(Complex.infOption && !MathFns.isInfinity(a) && b.isInfinite())return c;
        ...
        public Complex transposedOver(double a){
                Complex c = new Complex(0.0D, 0.0D);
                if(Complex.infOption && !MathFns.isInfinity(a) && this.isInfinite())return c;
        ...
        public static Complex sin(Complex aa ){
                ...
                double a = aa.real;
                double b = aa.imag;
                c.real = Math.sin(a)*MathFns.cosh(b);
                c.imag = Math.cos(a)*MathFns.sinh(b);
                return c;
        }
        ...
        public static Complex cos(Complex aa ){
                ...
                double a = aa.real;
                double b = aa.imag;
                c.real= Math.cos(a)*MathFns.cosh(b);
                c.imag= -Math.sin(a)*MathFns.sinh(b);
                return c;
        }
        ...
        public static Complex tan(Complex aa ){
                ...
                Complex x = new Complex(Math.sin(a)*MathFns.cosh(b), Math.cos(a)*MathFns.sinh(b));
                Complex y = new Complex(Math.cos(a)*MathFns.cosh(b), -Math.sin(a)*MathFns.sinh(b));
                c=Complex.over(x, y);
                return c;
        }
