...
mongoimport --db rivercast --collection col_equitycurve --file col_equitycurve.json --jsonArray
...
def get_3d_scatter_data():
    ...
    btcusd, es, us
    '''
    # fname_btcusd <= get fr mongo
    fname_es = 'esdata1col.csv'
    fname_us = 'usdata1col.csv'

    df0[df0['ts'].isin(df1['ts'])]
