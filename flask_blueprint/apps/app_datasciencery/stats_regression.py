...
def regr(Y, X, **param):
    ...
    """
    if not param:
        return reg_ols_sm(Y, X)
    elif 'lib' not in param:
        return reg_ols_sm(Y, X, **param)
    elif param['lib'] == 'statsmodels':
        return reg_ols_sm(Y, X, **param)
    elif param['lib'] == 'sklearn':
        return reg_ols_sklearn(Y, X, **param)


"""
Linear regression - statsmodels
"""
def reg_ols_sm(x, y, **param):
...
def transform_pctchange_clean_standardize_pd(x_all_raw:pd.core.series.Series) -> pd.core.series.Series:
...
def calc_matrix_reg(x_all:pd.core.series.Series, y_all:pd.core.series.Series, per_corr:int) -> list:
