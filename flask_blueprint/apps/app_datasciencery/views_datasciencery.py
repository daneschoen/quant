...
@app_datasciencery.route('test/jwplayer')
def test_jwplayer():
    return render_template('jwplayer.html')

@app_datasciencery.route('test/markdown0')
def test_markdown0():
    return render_template('markdown_0.html')

@app_datasciencery.route('test/markdown1')
def test_markdown1():
...
# Test: log
# ----------
@app_datasciencery.route('izmeginat/log0')
@requires_auth
def izmeginat_log0():
...
@app_datasciencery.route('izmeginat/log1')
def izmeginat_log1():
...
# Test: session, redis
# ---------------------
@app_datasciencery.route('izmeginat/session_put')
...
@app_datasciencery.route('izmeginat/session_get')
...
@app_datasciencery.route('izmeginat/redis_put')
...
@app_datasciencery.route('izmeginat/redis_get')
...
# Test: ROUTE
# ------------------------------
@app_datasciencery.route('izmeginat/route_host')
...
# ------------------------------
"""
@app_datasciencery.route('test/api_async0/')
@app_datasciencery.route('test/api_async0/<foo>')
...
@app_datasciencery.route('test/api0/<foo>/<bar>')
def test_api0(foo, bar):
    return jsonify({'foo':foo, 'bar':bar})

# X same!
@app_datasciencery.route('test/api1/<foo>/<bar>')
def test_api1(foo='foo', bar='bar'):
    return jsonify({'foo':foo, 'bar':bar})

# X same!
@app_datasciencery.route('test/api2/<foo>/<bar>/')
def test_api2(foo='foo', bar=None):
    return jsonify({'foo':foo, 'bar':bar})


@app_datasciencery.route('test/api3/<foo>/<bar>')
def test_api3(foo, bar):
    return jsonify(ret={'foo':foo, 'bar':bar})

@app_datasciencery.route('test/api4/<foo>/cow/<bar>')
...
"""
@app_datasciencery.route('test/api_default0/')
@app_datasciencery.route('test/api_default0/<foo>')
def test_api_default0(foo=None):
    return jsonify({'foo':foo})  # => js = {foo: null}

# ok - for 1 default nicer to use below
@app_datasciencery.route('test/api_default1/<user_id>', defaults={'username': 'Anonymous'})
@app_datasciencery.route('test/api_default1/<user_id>/<username>')
def test_api_default1(user_id, username):
    return user_id + ':' + username

# ok - *
@app_datasciencery.route('test/api_default2A/<user_id>')
@app_datasciencery.route('test/api_default2A/<user_id>/<username>')
def test_api_default2(user_id, username="Anonymous"):
    return user_id + ':' + username

# ok - careful with None
@app_datasciencery.route('test/api_default2B/<user_id>')
@app_datasciencery.route('test/api_default2B/<user_id>/<username>')
...
@app_datasciencery.route('test/api_default3A/<user_id>')
@app_datasciencery.route('test/api_default3A/<user_id>/<username>')
def test_api_default3A(user_id='-123', username=None):
    return jsonify({'user_id':user_id, 'username':username})


# ok - * this is 1/2 ways to have MULTIPLE DEFAULT PARAMS
@app_datasciencery.route('test/api_default3B/')
@app_datasciencery.route('test/api_default3B/<user_id>/')
@app_datasciencery.route('test/api_default3B/<user_id>/<username>')
def test_api_default3B(user_id='-123', username=None):
    return jsonify({'user_id':user_id, 'username':username})


# X! cant get this to work ...
@app_datasciencery.route('test/api_default4', defaults={'user_id': -123})
@app_datasciencery.route('test/api_default4/<user_id>', defaults={'username': 'Anonymous'})
@app_datasciencery.route('test/api_default4/<user_id>/<username>')
...
# X! NOT WORKING
@app_datasciencery.route('/test/api_catchall', defaults={'path': ''})
@app_datasciencery.route('/test/api_catchall/<path:path>')
...
@app_datasciencery.route('zdorovye/parbaudit')
@app_datasciencery.route('zdorovye/parbaudit/<component>')
...
@app_datasciencery.route('zdorovye/vesture')
@app_datasciencery.route('zdorovye/vesture/<sym>')
@app_datasciencery.route('zdorovye/vesture/<sym>/<last_per>')
...
"""
### Todo - protect!
@app_datasciencery.route('api/data/get_crypto_now')
def get_crypto_now():
    return get_crypto_live()
    # get_crypto_mongo()


@app_datasciencery.route('api/data/get_crypto_live')
def get_crypto_live():
...
@app_datasciencery.route('api/data/coin_top')
def get_coin_top():
    """
...
@app_datasciencery.route('api/plot/2d_btc_sp')
...
@app_datasciencery.route('api/data/get_hist_daily/<sym0>/<sym1>')
...
@app_datasciencery.route('api/plot/3d_ribbon')
...
@app_datasciencery.route('api/plot/3d_ribbon_demo')
...
@app_datasciencery.route('api/plot/3d_volatility')
...
@app_datasciencery.route('api/plot/3d_scatter_crypto_sp_')
def api_plot_3d_scatter_crypto_sp_():
#@app_datasciencery.route('api/plot/3d_scatter_crypto_sp_time')
...
@app_datasciencery.route('api/data/get_coin_spec/<sym>')
...
@app_datasciencery.route('api/tron/run_get_update_coin_hist')
@requires_auth
...
# ------------------------------------------------------------------------------
@app_datasciencery.route('/')
def index():
    return render_template('index_land_datasciencery.html')

@app_datasciencery.route('_dev_')
def index_dev():
    return render_template('index_land_datasciencery_dev.html')


@app_datasciencery.route(PLOT_ROUTES['pair'])
def datascience():
    return render_template('datascience.html')

@app_datasciencery.route('/pitch_private')
def pitch_private():
    #return redirect(url_for('foo'))
    return redirect("/laplacian/pitch_private", code=302)

@app_datasciencery.route('/about')
def about():
    return render_template('about_datasciencery.html')

@app_datasciencery.route('/blog')
def about_blog():
    return render_template('about_datasciencery.html')
...
# ------------------------
@app_datasciencery.route('3D-line')
def index_3d_ribbon():
    """
    d_data = api_plot_3d_ribbon()
...
@app_datasciencery.route('3D-volatility')
def index_3d_volatility():
    return render_template('3d_volatility.html')


@app_datasciencery.route('3D-correlation')
def index_3d_correl():
    return render_template('3d_volatility.html')


@app_datasciencery.route('3D-correlation-scatter')
...
# Routes: Raksts
# -------------------
@app_datasciencery.route('<slug>')
def article_(slug):
    return render_template('art_' + slug + '.html',
      domain='DataSciencery',
      title='DataSciencery - Predicting the Future'
    )

@app_datasciencery.route('/article/causes-bitcoin-decline')
def index_article_causes_bitcoin_decline():
    return render_template('raks_.html')

@app_datasciencery.route('/technology_programming_loved')
def art_technology_programming_loved():
    return render_template('art_technology_programming_loved.html',
                            domain='DataSciencery',
                            title='DataSciencery - Predicting the Future'
                          )
...
# ------------------------------------------------------------------------------
@app_datasciencery.route('contact/')
@app_datasciencery.route('contact/<name>')
@login_required
...
@app_datasciencery.route('contact_get', methods=['GET'])
@login_required
def contact_get():
...
# public API
# ------------------------------------------------------------------------------
@app_datasciencery.route('email/contactme', methods=['GET', 'POST'])
def contactme():
    res_jsn = {
...
@app_datasciencery.route('email/mailinglist_insert', methods=['GET', 'POST'])
@login_required
...
@app_datasciencery.route('email/mailinglist_delete', methods=['GET', 'POST'])
@login_required
...
@app_datasciencery.route('email/mailinglist_send', methods=['GET', 'POST'])
@login_required
